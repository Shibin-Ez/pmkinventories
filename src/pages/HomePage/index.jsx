...
const HomePage = () => {
  const [sideUserData, setSideUserData] = useState(["loading", "loading", "loading"]);
  const [sideSiteData, setSideSiteData] = useState(["loading", "loading", "loading"]);
  const [sideInventoryData, setSideInventoryData] = useState(["loading", "loading", "loading"]);
